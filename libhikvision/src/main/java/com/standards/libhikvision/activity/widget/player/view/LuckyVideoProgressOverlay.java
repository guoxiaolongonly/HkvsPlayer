 ...
 * 滑动快进快退进度框
 */
public class LuckyVideoProgressOverlay extends FrameLayout {
    ...
    public LuckyVideoProgressOverlay(Context context) {
        super(context);
        init();
    }

    public LuckyVideoProgressOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LuckyVideoProgressOverlay(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void show(int delProgress, int curPosition, int duration) {
        ...
        mSeekCurProgress.setText(StringUtils.millToTime(targetProgress));
        mSeekDuration.setText(StringUtils.millToTime(mDuration));
    }
