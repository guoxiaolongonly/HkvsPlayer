 ...
 * 视频错误View
 */
public class LuckyVideoErrorView extends FrameLayout {
    // 正常状态
    ...
    private OnVideoControlListener onErrorListener;

    public LuckyVideoErrorView(Context context) {
        super(context);
        init();
    }

    public LuckyVideoErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LuckyVideoErrorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        video_error_retry.setOnClickListener(v -> {
            if (onErrorListener != null) {
                onErrorListener.onErrorClick(curStatus);
            }
        });
    ...
    public void setOnVideoControlListener(OnVideoControlListener onVideoControlListener) {
        this.onErrorListener = onVideoControlListener;
    }
