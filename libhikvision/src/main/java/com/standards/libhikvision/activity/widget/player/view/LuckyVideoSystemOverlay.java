 ...
 * 滑动变化音量|亮度框
 */
public class LuckyVideoSystemOverlay extends FrameLayout {
    ...
    public LuckyVideoSystemOverlay(Context context) {
        super(context);
        initialize(context);
    }

    public LuckyVideoSystemOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public LuckyVideoSystemOverlay(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
